...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.mac_to_port = {}
        self.mitigation = 1  # Bật chức năng giảm thiểu tấn công
        self.arp_ip_to_port = {}
        self.blocked_ports = {}
    ...
    def install_meter(self, datapath, meter_id, rate_kbps):
        ofproto = datapath.ofproto
        parser = datapath.ofproto_parser

        bands = [parser.OFPMeterBandDrop(rate=rate_kbps, burst_size=rate_kbps)]
    ...
    def limit_port_bandwidth(self, datapath, portnumber, meter_id=1, rate_kbps=512):
        parser = datapath.ofproto_parser
        ofproto = datapath.ofproto

        self.install_meter(datapath, meter_id, rate_kbps)
            ...
            if self.mitigation:
                ...
                if srcip not in self.arp_ip_to_port[dpid][in_port]:
                    if in_port not in self.blocked_ports[dpid]:
                        ...
                        print("Limit Bandwidth Port ", in_port)
                        self.limit_port_bandwidth(datapath, in_port,
                                                  meter_id=in_port, rate_kbps=256)
